...
if torch is not None:
    ...
    class GraphSurrogateModel:  # type: ignore
        """Stub surrogate model when torch is unavailable."""

        def __init__(self, *_: object, **__: object) -> None:
            raise RuntimeError("Torch is required for GraphSurrogateModel.")


    def predict(*_: object, **__: object) -> np.ndarray:
        raise RuntimeError("Torch is required for predict().")
