...
&nbsp; - `tests/test\_mna\_\*.py`

&nbsp; - `tests/test\_mor\_\*.py`

&nbsp; - `tests/test\_vector\_fit\_\*.py`

&nbsp; - `tests/test\_fractional\_fit\_\*.py`

&nbsp; - `tests/test\_dsl\_\*.py`

&nbsp; - `tests/test\_search\_\*.py`
...
&nbsp;  - e.g., changing `mna/assemble.py` → run `tests/test\_mna\_\*`
...
&nbsp;  - run the broader set in that domain (often all `tests/test\_\*.py` in core areas).
...
\- `tests/test\_mna\_port\_impedance.py` — covers `fidp/evaluators/mna/port\_impedance.py` + edge cases for singular matrices.
